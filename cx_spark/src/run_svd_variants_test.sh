...
spark-submit --master local[2] --verbose --class org.apache.spark.mllib.linalg.distributed.SVDVariants $1 csv $DATADIR/input.csv 55 200 $DATADIR/output.bin 10 2 5
