...
%%MM%% \section{Dummy Citation}
%%MM%% Dummy citation for Bib\TeX:
%%MM%% \LaTeX\cite{Lamport:LaTeX}
...
%%MM%% \subsection{References}
%%MM%% Generated by bibtex from your ~.bib file.  Run latex,
%%MM%% then bibtex, then latex twice (to resolve references)
%%MM%% to create the ~.bbl file.  Insert that ~.bbl file into
%%MM%% the .tex source file and comment out
%%MM%% the command \texttt{{\char'134}thebibliography}.
