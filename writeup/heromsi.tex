...
\alignauthor
Jey Kottalam\\
\affaddr{Berkeley Institute for Data Science and EECS Department, University of California, Berkeley}\\
\email{jey@berkeley.edu}
\alignauthor
Jiyan Yang\\
\affaddr{Institute for Computational and Mathematical Engineering, Stanford University}\\
...
\alignauthor
Evan Racah\\
\affaddr{Computational Research Division, Lawrence Berkeley Laboratory}\\
\email{eracah@lbl.gov}
\alignauthor
Alex Gittens\\
\affaddr{International Computer Science Institute and Department of Statistics, University of California, Berkeley}\\
...
\alignauthor
Ben Bowen\\
\affaddr{Life Sciences Division, Lawrence Berkeley Laboratory}\\
