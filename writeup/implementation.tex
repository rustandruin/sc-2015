...
This approach may be implemented in Spark as a \ttt{map} to form the outer products followed by a \ttt{reduce}
...
The \ttt{treeAggregate} operation is equivalent to a map-reduce that executes in-place to accumulate the contribution of a 
