...
%%when we double the core count to 960.
  ...
  \label{sect:h2h}
    ...
    \end{centering}
    \caption{ Run times for the various stages of computation for CX for the three platforms using $k=16$ on two different size datasets and default partitioning for the given platform} 
    \label{fig:h2hrank16} 
    \end{figure}
